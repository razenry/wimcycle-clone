...
<div class="page-body">
    <div class="container-xl">        
        ...
        <div class="d-flex justify-content-start mb-3 mt-3">
            <a href="<?= Routes::base('frame/form/add') ?>" class="btn btn-primary">
                ...
                <tbody class="table-tbody">
                    ...
                    foreach ($frames as $frame) : ?>
                        <tr>
                            ...
                            <td class="sort-name"><?= $frame['name'] ?></td>
                            <td class="sort-name text-center">

                                <?php if ($frame['status'] == 1) : ?>
                                    <a href="<?= Routes::base('frame/status/' . $frame['slug'] . '/non-active') ?>">
                                ...
                                <?php endif; ?>
                                <?php if ($frame['status'] == 0) : ?>
                                    <a href="<?= Routes::base('frame/status/' . $frame['slug'] . '/active') ?>">
                            ...
                            <td class="sort-type d-flex gap-3 justify-content-center align-item-center">
                                <a href="<?= Routes::base('frame/detail/' . $frame['slug']) ?>" class="text-info">
                                ...
                                <!-- Edit -->
                                <a href="<?= Routes::base('frame/form/update/' . $frame['slug']) ?>" class="text-warning">
                                ...
                                <a href="<?= Routes::base('frame/delete/' . $frame['slug']) ?>" class="text-danger delete-btn">
