                    ...
                    foreach ($categories as $category) : ?>
                        <tr>
                            ...
                            <td class="sort-name text-center">
                                <a href="<?= Routes::storage('categories/' . $category['photo']) ?>" class="text-primary" data-bs-toggle="modal" data-bs-target="#imagePreviewModal" data-image-url="<?= Routes::storage('categories/' . $category['photo']) ?>">
                            ...
                            <td class="sort-name text-center">
                                ...
                                <?php if ($category['status'] == 1) : ?>
                                    <a href="<?= Routes::base('category/status/' . $category['slug'] . '/non-active') ?>">
                                ...
                                <?php if ($category['status'] == 0) : ?>
                                    <a href="<?= Routes::base('category/status/' . $category['slug'] . '/active') ?>">
                            ...
                            <td class="sort-type d-flex gap-3 justify-content-center align-item-center">
                                <a href="<?= Routes::base('category/detail/' . $category['slug']) ?>" class="text-info">
                                ...
                                <!-- Edit -->
                                <a href="<?= Routes::base('category/form/update/' . $category['slug']) ?>" class="text-warning">
                                ...
                                <a href="<?= Routes::base('category/delete/' . $category['slug']) ?>" class="text-danger delete-btn">
