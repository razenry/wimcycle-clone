...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="d-flex justify-content-start mb-3 mt-3">
            <a href="<?= Routes::base('product/form/add') ?>" class="btn btn-primary">
                ...
                <tbody class="table-tbody">
                    ...
                    foreach ($products as $product) : ?>
                        <tr>
                            ...
                            <td class="sort-name"><?= $product['product']['name'] ?></td>
                            <td class="sort-name"><?= $product['product']['category']['name'] ?></td>
                            <td class="sort-name"><?= CurrencyFormatter::formatCurrency($product['product']['price']) ?></td>
                            <td class="sort-name text-center">
                                <a href="<?= Routes::storage('product/' . $product['product']['photo']) ?>" class="text-primary" data-bs-toggle="modal" data-bs-target="#imagePreviewModal" data-image-url="<?= Routes::storage('product/' . $product['product']['photo']) ?>">
                            ...
                            <td class="sort-name text-center">
                                ...
                                <?php if ($product['product']['status'] == 1) : ?>
                                    <a href="<?= Routes::base('product/status/' . $product['product']['slug'] . '/non-active') ?>">
                                ...
                                <?php if ($product['product']['status'] == 0) : ?>
                                    <a href="<?= Routes::base('product/status/' . $product['product']['slug'] . '/active') ?>">
                            ...
                            <td class="sort-type d-flex gap-3 justify-content-center align-item-center">
                                <a href="<?= Routes::base('product/detail/' . $product['product']['slug']) ?>" class="text-info">
                                ...
                                <!-- Edit -->
                                <a href="<?= Routes::base('product/form/update/' . $product['product']['slug']) ?>" class="text-warning">
                                ...
                                <a href="<?= Routes::base('product/delete/' . $product['product']['slug']) ?>" class="text-danger delete-btn">
