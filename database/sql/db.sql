...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 01, 2024 at 03:21 AM
...
CREATE TABLE `laporan` (
  ...
  `status` enum('Menunggu','Diverifikasi','Dalam tindakan','Tuntas','Ditolak') NOT NULL,
...
(1, 8, 'test admin', 0, 'anonim', 'Ditolak', '2024-08-31', '19:16:19', 'Serpong ', 'Buaran'),
(2, 12, 'Test Admin Untuk Laporan', 0, 'rahasia', 'Dalam tindakan', '2024-08-31', '00:59:47', 'Serpong ', 'Buaran');
...
(8, 'Abdul Jabbar', 'user-1725151691_383d8f3ce1.png', 'arewegoto@gmail.com', '$2y$10$6DGefU0lxVCbRmBG2A8yceBZwxSr7coyPxZ2uzFn9Huhvvuv.7oGe', '', '1'),
