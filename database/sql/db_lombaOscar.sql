...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 31, 2024 at 07:25 PM
...
CREATE TABLE `laporan` (
  ...
  `status` enum('menunggu','diverifikasi','dalamTindakan','tuntas','ditolak') NOT NULL,
...
INSERT INTO `laporan` (`id`, `id_pengguna`, `isi_laporan`, `jenis_laporan`, `status`, `tgl_laporan`, `jam_lapor`, `kecamatan`, `kelurahan`) VALUES
(1, 8, 'test admin', 'anonim', 'menunggu', '2024-08-31', '19:16:19', 'Serpong ', 'Buaran');
...
(8, 'Abdul Jabbar', 'user-1724845318_d3e6808c3e.png', 'arewegoto@gmail.com', '$2y$10$6DGefU0lxVCbRmBG2A8yceBZwxSr7coyPxZ2uzFn9Huhvvuv.7oGe', '', '1'),
...
--
ALTER TABLE `laporan`
  ADD CONSTRAINT `laporan_ibfk_1` FOREIGN KEY (`id_pengguna`) REFERENCES `pengguna` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
